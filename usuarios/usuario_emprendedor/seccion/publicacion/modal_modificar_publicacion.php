...
<div class="modal fade" id="modal_modificar_publicacion" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal_modificar_publicacionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data" id="formulario_modificar_publicacion">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 form-floating mb-3" id="grupo_txtDescripcion">
                        ...
                        <textarea style="height:150px;" class="form-control" name="txt_descripcion_modificar" placeholder="Descripcion" id="txt_descripcion_modificar" data-max="255" minlength="1" maxlength="255" style="height: 100px" required></textarea>
...
<script>
    ...
    function compararDatosOriginalesConFormularioModificar() {
        ...
        const archivosIguales = lista_archivos_modificar_bd.length === lista_archivos_modificar.length &&
            lista_archivos_modificar.length === 0 &&
            lista_archivos_modificar_bd.every(valor => lista_archivos_modificar.includes(valor));

        // Comprobación general
        return descripcionIgual && coordenadasIguales && archivosIguales;
    }
    ...
    formulario_modificar_publicacion.addEventListener('submit', function(event) {
        ...
        formData.append('descripcion', txt_descripcion_modificar.value.trim());
        ...
        fetch('modificar_publicacion.php', {
                method: 'POST',
                body: formData
            })
