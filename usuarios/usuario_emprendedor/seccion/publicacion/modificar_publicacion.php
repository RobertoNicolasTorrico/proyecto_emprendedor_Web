...
$campo_esperados = ['id_publicacion_modificar', 'txt_descripcion_modificar'];
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST)) {
        ...
        if (tieneEspaciosInicioFinCadena($descripcion)) {
            throw new Exception("La descripcion no puede tener espacios en blanco al inicio o al final");
        }
