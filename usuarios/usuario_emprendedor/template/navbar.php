                ...
                <div class=" offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="navbar_usuario_emprendedor" aria-labelledby="navbar_usuario_emprendedor">
                        ...
                        <div class="offcanvas-body">
                                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                        ...
                                        <!--Dropdown para ver los Productos, Publicaciones, Preguntas hechas, Preguntas recibidas e Lista de Seguidos y Seguidores del usuario-->
                                        <li class="nav-item dropdown">
                                                <button class="btn btn-dark dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Ver mis</button>
                                                <ul class="dropdown-menu dropdown-menu-dark">
                                                        <!--Enlace para ir donde estan los productos publicados del usuario emprendedor -->
                                                        <li class="nav-item">
                                                                <a class="dropdown-item" href="<?php echo ($url_usuario_emprendedor); ?>/seccion/producto/pagina_lista_producto.php">Productos</a>
                                                        </li>

                                                        <!--Enlace para ir donde estan las publicaciones del usuario emprendedor -->
                                                        <li class="nav-item">
                                                                <a class="dropdown-item" href="<?php echo ($url_usuario_emprendedor); ?>/seccion/publicacion/pagina_lista_publicacion.php">Publicaciones</a>
                                                        </li>
                                                        ...
                                                        <!--Enlace para ir donde estan las preguntas que recibio el usuario emprendedor por sus productos -->
                                                        <li class="nav-item">
                                                                <a class="dropdown-item" href="<?php echo ($url_usuario_emprendedor); ?>/seccion/respuesta_pregunta/pagina_lista_respuesta_pregunta.php">Preguntas recibidas</a>
                                                        </li>

                                                        <!--Enlace para ir donde estan las lista seguidos y seguidores del usuario emprendedor-->
                                                        <li class="nav-item">
                                                                <a class="dropdown-item" href="<?php echo ($url_usuario); ?>/seguidores_seguidos/pagina_seguidores_seguidos.php">Lista de Seguidos y Seguidores</a>
                                                        </li>
                                                </ul>
                                        </li>


                                        <!--Enlace para entrar al perfil del usuario emprendedor-->
                                        <li class="nav-item ">
                                                <a class="btn btn-dark text-white" href="<?php echo ($url_usuario_emprendedor); ?>/seccion/perfil/pagina_perfil.php?id=<?php echo ($id_usuario_emprendedor); ?>&token=<?php echo ($id_usuario_emprendedor_token); ?>">Perfil</a>
                                        </li>
