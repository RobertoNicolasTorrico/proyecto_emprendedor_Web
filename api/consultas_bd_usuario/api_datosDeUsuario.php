...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        if (!verificarSiEsUsuarioValido($conexion, $id_usuario,  $tipo_usuario)) {
            throw new Exception("No se puede obtener la informacion de la cuenta del usuario debido a que su cuenta no esta activa o esta baneado");
        }

        //Se obtiene los datos del usuario 
        $respuesta['datosUsuario'] = obtenerDatosUsuarioPorIdUsuario($conexion, $id_usuario);
