...
try {
    ...
    // Verificar datos de sesión del usuario administrador y redirigidir a la pagina de inicio del usuario administrador si la sesion es valida
    verificarSiUsuarioAdministradorInicioSesion($conexion);


    /*
    $nombre_usuario="adminstrador10";
    $nombres="Roberto Nicolas Agustin";
    $apellidos="Torrico";
    $email="nicolastorrico0@gmail.com";
    $password="123456";
    altaUsuarioAdmin($conexion, $nombre_usuario, $nombres, $apellidos, $email, $password);
   */
} catch (Exception $e) {
...
<head>
    ...
    <!--Titulo de la página-->
    <title>Proyecto Emprendedor Administrador Iniciar sesion</title>
                    ...
                    <div class="col-12 col-sm-12 col-md-8 col-lg-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="text-center">Iniciar sesión administrador</h5>
                            </div>

                            <!-- Body del Card -->
                            <div class="card-body">

                                <!--Formulario para inciar sesion como administrador-->
                                ...
                                <div class="text-center">
                                    <a href="../recuperar_cuenta_password/pagina_enviar_email_recuperar.php">¿Olvidaste tu contraseña?</a>
                                </div>
                            </div>
...
<script>
    ...
    //Manejo del envio del formulario para iniciar sesion commo administrador
    form_Iniciar_Sesion.addEventListener('submit', function(event) {
        ...
        fetch('iniciar_sesion_admin.php', {
                method: 'POST',
                body: formData
            })
            ...
            .then(datos => {
                ...
                if (datos.lista.length > 0) {
                    ...
                    if (datos.estado == 'danger') {
                        ...
                        //Se verifica que en caso que se reciba la URL direccionada al usuario a la pagina de inicio del usuario administrador
