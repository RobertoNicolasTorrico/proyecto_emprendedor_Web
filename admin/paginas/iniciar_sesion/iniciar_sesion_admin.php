...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST)) {
        ...
        $usuario_administrador = login_usuario_admin($conexion, $email, $password);
        ...
        $_SESSION['id_usuario_administrador'] = $usuario_administrador['id_usuario_administrador'];
        $_SESSION['tipo_usuario_admin'] = "admin";


        //Direccion donde va a llevar al usuario administrador
        global $url_usuario_admin;
        $respuesta['url'] = $url_usuario_admin . "/index.php";
    } else {
