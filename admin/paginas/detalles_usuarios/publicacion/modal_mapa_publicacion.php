...
<script>
    ...
    modal_ver_map.addEventListener('shown.bs.modal', event => {
        ...
        var latitud = button.getAttribute('data-bs-latitud');
        var longitud = button.getAttribute('data-bs-longitud');

        //LLama a la funcion para agregar el contenido del mapa al Div
        verUbicacionMapPublicacionesModal(latitud, longitud, 'map_publicaciones', "Ubicacion Actual de la publicacion");
    });
