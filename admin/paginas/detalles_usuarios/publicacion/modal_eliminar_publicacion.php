...
<div class="modal fade" id="modal_eliminar_publicacion" tabindex="-1" aria-labelledby="modal_eliminar_publicacionLabel" aria-hidden="true">
...
<script>
    ...
    const ventanaModalEliminarPublicacion = new bootstrap.Modal(eliminaPublicacionModal);
    ...
    formulario_eliminar_publicacion.addEventListener("submit", (e) => {
        ...
        fetch(`publicacion/baja_publicacion.php${window.location.search}`, {
                method: 'POST',
                body: formData
            })
            ...
            .then(datos => {
                if (datos.estado == "success") {
                    ...
                    if (cant_actual_registros_publicacion == 1 && pagina_actual_publicacion > 1) {
                        pagina_actual_publicacion = pagina_actual_publicacion - 1;
                    }
                    ...
                    //Cierra el modal 
                    ventanaModalEliminarPublicacion.hide();
