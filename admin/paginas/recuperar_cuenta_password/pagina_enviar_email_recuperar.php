            ...
            <?php if (empty($mensaje_error)) { ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-12 col-md-8 col-lg-6">
                        ...
                        <form id="formulario_recuperar_cuenta">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h5 class="text-center">Recuperar contraseña del administrador</h5>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a class="btn btn-outline-primary" id="boton_cancelar" href="../iniciar_sesion/pagina_iniciar_sesion_admin.php">Cancelar</a>
...
<script>
    ...
    form_recuperar_cuenta.addEventListener('submit', function(event) {
        ...
        fetch('enviar_email_cambio_contrasenia.php', {
                method: 'POST',
                body: formData
            })
