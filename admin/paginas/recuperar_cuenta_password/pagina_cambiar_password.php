...
try {
    ...
    if (!empty($token)) {
        //Se verifica que el usuario administrador si halla pedido recuperar la contraseña
        $token_valido = validarTokenNuevaPasswordAdmin($conexion, $token, $id_admin);
        if (!$token_valido) {
...
<head>
    ...
    <!--Titulo de la página-->
    <title>Proyecto emprendedor Cambiar Contraseña Admin</title>
                        ...
                        <form id="formulario_cambiar_password" method="POST">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h5 class="text-center">Cambiar Contraseña del administrador</h5>
                                </div>
                ...
                .then(datos => {
                    if (datos.lista.length > 0) {
                        ...
                        if (datos.estado === 'success') {
                            ...
                            url_base = url_base + "/admin/paginas/iniciar_sesion/pagina_iniciar_sesion_admin.php";
