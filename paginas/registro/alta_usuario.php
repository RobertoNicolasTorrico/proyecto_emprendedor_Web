...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST)) {
        ...
        $mensaje_activacion = "Si no has recibido el correo electrónico para activar tu cuenta, haz clic en el siguiente <a target='_blank' href='$url'> enlace</a> para reenviarlo.";

        $respuesta['mensaje'] = 'En unos minutos recibirás un correo electrónico para finalizar el proceso de registro. Revisa tanto la bandeja de entrada como la de correo no deseado para confirmar tu registro e iniciar sesión.' . $mensaje_activacion;
    } else {
